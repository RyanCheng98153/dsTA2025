...
function sendLetter(call, callback) {
    ...
    const sn=call.request.studentName;
    const ti=tracking_id;
    const h=house;
    console.log(`寄送信件給 ${sn}, 學院：${h}, 追蹤碼：${ti}`);
    ...
    const sn1=call.request.studentName;
    const ti1=tracking_id;
    const h1=house;
    callback(null, { studentName: sn1, house: h1, trackingId: ti1 });
