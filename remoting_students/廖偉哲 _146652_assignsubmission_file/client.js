// 這與 track.js 的開頭一模一樣，用來載入 owl_post.proto，並取得 gRPC 定義
// owlpost 是 .proto 檔中定義的 package 名稱
// owlPostProto.OwlPost 是 .proto 中定義的 service OwlPost
...
// 連接到 server（localhost:50051），用來呼叫 sendLetter() 方法
