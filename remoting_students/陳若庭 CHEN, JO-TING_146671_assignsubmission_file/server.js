...
const packageDefinition = protoLoader.loadSync('owl_post.proto', {keepCase: true});
...
function sendLetter(call, callback) {
    ...
    // ==== 請完成實作 (以下) ==== 
    console.log(`寄送信件給 ${call.request.studentName}\n`);
    console.log(`學院: ${house}\n`);
    console.log(`追蹤碼: ${tracking_id}\n`);
    // ==== 請完成實作 (以上) ==== 
