...
export const options = {
  stages: [
    ...
    {duration: '2s', target: 1200}, // 2 秒後增加到 1200 個使用者
    {duration: '2s', target: 1600}, // 2 秒後增加到 1600 個使用者
    {duration: '2s', target: 2000}, // 2 秒後增加到 2000 個使用者
    {duration: '2s', target: 2400}, // 2 秒後增加到 2400 個使用者
    // ====== 請實作以上內容 ======
  ],
};
