...
export const options = {
  stages: [
    // ===== 請實作以下內容 ======
      ...
      { duration: '2s', target: 1200 }, // 4 秒後增加到 1200 個使用者
      { duration: '2s', target: 1600 }, // 6 秒後增加到 1600 個使用者
      { duration: '2s', target: 2000 }, // 8 秒後增加到 2000 個使用者
      { duration: '2s', target: 2400 }, // 10 秒後增加到 2400 個使用者
    // ====== 請實作以上內容 ======
  ],
};
